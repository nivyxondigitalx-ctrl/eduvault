    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-zinc-950">
        <div className="flex flex-col items-center gap-3">
          <Briefcase className="w-10 h-10 text-indigo-600 animate-bounce" />
          <p className="text-xs font-semibold text-slate-500">Loading Dealer Workspace...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-xs text-slate-500 mt-2">This dashboard is restricted to Dealer accounts. Your current role is: <strong className="capitalize">{currentUser.role}</strong>.</p>
          <button

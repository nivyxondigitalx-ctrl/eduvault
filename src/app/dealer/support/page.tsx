...
import { HelpCircle, Send, MessageSquare, PlusCircle, AlertCircle, X } from "lucide-react";
...
export default function DealerSupportPage() {
  ...
  const dealerTickets = tickets.filter((t) => t.userId === currentUser?.id);
  ...
  const handleCreateTicket = (e: React.FormEvent) => {
    ...
    toast.success("Helpdesk query submitted successfully!");
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400 mt-0.5">
            Submit support tickets for payouts processing delays, uploading classification issues, or copyright disputes.
          </p>
        </div>
        <button
      ...
      {dealerTickets.length === 0 ? (
        <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-12 text-center max-w-md mx-auto">
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400 mt-2 leading-relaxed">
            You don't have any support queries open. Click "New Ticket" to message platform admins.
          </p>
        </div>
      ) : (
          ...
          <div className="md:col-span-2">
            {selectedTicket ? (
              <div className="bg-white dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-3xl p-6 space-y-6">
                ...
                <div className="space-y-4 max-h-[300px] overflow-y-auto pr-1">
                  ...
                  <div className="bg-slate-50 dark:bg-zinc-800 p-3.5 rounded-2xl border border-slate-100 dark:border-zinc-800/60">
                    <p className="text-[10px] font-bold text-slate-700 dark:text-zinc-300">{currentUser?.name} (Dealer)</p>
              ...
              <div className="bg-slate-50 dark:bg-zinc-900/50 border border-slate-100 dark:border-zinc-800/80 rounded-3xl p-12 text-center text-xs text-slate-400 dark:text-zinc-500">
                Select a support ticket from the left panel.
              </div>
            )}
          </div>
            ...
            <form onSubmit={handleCreateTicket} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. payout dispute check request"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Explain your payout or upload issues."

    ...
    return (
      <div className="min-h-screen flex flex-col bg-slate-50">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-xs text-slate-500 mt-2">This dashboard is restricted to Student accounts. Your current role is: <strong className="capitalize">{currentUser.role}</strong>.</p>
          <button

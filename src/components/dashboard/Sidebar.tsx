...
export const Sidebar: React.FC<SidebarProps> = ({ role }) => {
  ...
  return (
    <aside className="w-64 shrink-0 bg-white dark:bg-zinc-900 border-r border-slate-100 dark:border-zinc-800 flex flex-col h-[calc(100vh-4rem)] sticky top-16 z-20">
      {/* Profile summary */}
